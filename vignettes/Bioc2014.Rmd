...
Extract the index of the MS2 spectrum with a high base peak intensity
and plot its spectrum. Is the data centroided or in profile mode?
...
identification results. The `MSnbase` package 
...
ans
kcl <- MLearn( ~ ., data = dunkley2006, kmeansI, centers = 5)
kcl
```
