...
The `isobar` pipeline also provides 

Other data processing methods such as isobaric tags purification 


The `combineFeatures` method combines spectra/petides quantitation
values into protein data. The 
...
suited for the statistical analysis of data.
